# -*- coding: utf-8 -*-
"""สำเนาของ dm_mvmnt_pz_lib.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/17pKVIOV4k4N2CoWRch2T46UVPuOPgFeO
"""

#!/usr/bin/env python
# coding: utf-8
#!pip install pandasql # Install pandasql
import pandas as pd
...
def dm_mvmnt_result(cutoff_date, dm_invent_csv, dm_movement_csv):
    ...
    # Read the CSV file
    df = pd.read_csv(output_file, usecols=[1, 8, 15, 24], parse_dates=['Shlf.Date'], date_format='%m-%d-%y')
...
if __name__ == "__main__":
    ...
    dm_invent_csv = '/content/drive/MyDrive/dm_inv/dm_inv/PZ_inven_Dec_11_2024.XLS.csv'
    # Define DM Movement Raw data CSV file name
    dm_movement_csv = '/content/drive/MyDrive/dm_inv/dm_inv/movement Jan-Oct_24_120.csv'
